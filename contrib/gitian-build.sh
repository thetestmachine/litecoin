...
VERSION=
commit=false
url=https://github.com/einsteinium/einsteinium
proc=2
mem=2000
lxc=true
...
-u|--url	Specify the URL of the repository. Default is https://github.com/einsteinium/einsteinium
...
then
    ...
    git clone https://github.com/einsteinium/gitian.sigs.ltc.git
    git clone https://github.com/einsteinium/einsteinium-detached-sigs.git
